Stating a precise definition of \grqq{}Neural Network\glqq{} is quite involved. 
...
\begin{figure}[h]
    ...
    \end{tikzpicture}
    \caption{Visualization of a feed forward neural network. \comment{warum können nicht einfach alle nodes gleich groß sein?!}}
    \label{fig:nn}
\end{figure}
